...
void main() async {
  ...
  String seedNormal = 'ship_remodel';
  String cipherNormal = createCipher(id, seedNormal);
  
  String seedDmg = 'ship_remodel_dmg';
  String cipherDmg = createCipher(id, seedDmg);

  print('Normal: http://203.104.209.71/kcs2/resources/ship/remodel/${paddedId}_${cipherNormal}.png');
  print('Dmg:    http://203.104.209.71/kcs2/resources/ship/remodel/${paddedId}_${cipherDmg}.png');
}
