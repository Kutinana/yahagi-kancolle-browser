...
void main() {
  ...
  group('Requirement 1: Practice base experience formula & edge cases', () {
    test('Calculates exact theoretical values with sqrt decay when total > 500', () {
      // Benchmark 1: L1=80, L2=60 -> total=3750 -> 500 + sqrt(3250) = 557
      expect(GameInfoNoticeController.calculatePracticeBaseExp(80, 60), equals(557));

      // Benchmark 2: L1=50, L2=0 (single ship) -> total=1225 -> 500 + sqrt(725) = 526
      expect(GameInfoNoticeController.calculatePracticeBaseExp(50, 0), equals(526));

      // Benchmark 3: L1=120, L2=120 -> total=11360 -> 500 + sqrt(10860) = 606
      expect(GameInfoNoticeController.calculatePracticeBaseExp(120, 120), equals(606));
    });

    test('Calculates small totals without decay when total <= 500', () {
      // L1=10, L2=10 -> total=60
      expect(GameInfoNoticeController.calculatePracticeBaseExp(10, 10), equals(60));

      // L1=1, L2=1 -> total=0 -> floor limit 10
      expect(GameInfoNoticeController.calculatePracticeBaseExp(1, 1), equals(10));
    });

    test('Handles 0-ship and abnormal inputs safely', () {
      // Opponent first ship level <= 0 means empty/missing deck
      expect(GameInfoNoticeController.calculatePracticeBaseExp(0, 0), equals(0));
      expect(GameInfoNoticeController.calculatePracticeBaseExp(0, 80), equals(0));
      expect(GameInfoNoticeController.calculatePracticeBaseExp(-1, 80), equals(0));
      expect(GameInfoNoticeController.calculatePracticeBaseExp(80, -5), equals(551));
    });

    test('Practice API event with single ship opponent computes and displays', () async {
    ...
    test('Practice API event with empty ships list is ignored safely', () async {
      final controller = GameInfoNoticeController(
        stateProvider: () => state,
        layoutSettingsController: layoutController,
        topNoticeController: topNoticeController,
  ...
  group('Requirement 2: Training cruiser bonus 4-mode matrix', () {
    ...
    test('Mode 1: CT Flagship only', () {
      expect(
        GameInfoNoticeController.calculateFleetTrainingCruiserBonus(
          makeFleetWithCt(flagshipIsCt: true, flagshipLevel: 5, ctCompanionCount: 0, ctCompanionLevel: 1),
        ),
        equals(5.0),
      );
      expect(
        GameInfoNoticeController.calculateFleetTrainingCruiserBonus(
          makeFleetWithCt(flagshipIsCt: true, flagshipLevel: 25, ctCompanionCount: 0, ctCompanionLevel: 1),
        ),
        equals(8.0),
      );
      expect(
        GameInfoNoticeController.calculateFleetTrainingCruiserBonus(
          makeFleetWithCt(flagshipIsCt: true, flagshipLevel: 45, ctCompanionCount: 0, ctCompanionLevel: 1),
        ),
        equals(12.0),
      );
      expect(
        GameInfoNoticeController.calculateFleetTrainingCruiserBonus(
          makeFleetWithCt(flagshipIsCt: true, flagshipLevel: 75, ctCompanionCount: 0, ctCompanionLevel: 1),
        ),
        equals(15.0),
      );
      expect(
        GameInfoNoticeController.calculateFleetTrainingCruiserBonus(
          makeFleetWithCt(flagshipIsCt: true, flagshipLevel: 120, ctCompanionCount: 0, ctCompanionLevel: 1),
        ),
        equals(20.0),
      );
    });
    ...
    test('Mode 2: CT Flagship + Companion', () {
      expect(
        GameInfoNoticeController.calculateFleetTrainingCruiserBonus(
          makeFleetWithCt(flagshipIsCt: true, flagshipLevel: 5, ctCompanionCount: 1, ctCompanionLevel: 30),
        ),
        equals(10.0),
      );
      expect(
        GameInfoNoticeController.calculateFleetTrainingCruiserBonus(
          makeFleetWithCt(flagshipIsCt: true, flagshipLevel: 25, ctCompanionCount: 1, ctCompanionLevel: 30),
        ),
        equals(13.0),
      );
      expect(
        GameInfoNoticeController.calculateFleetTrainingCruiserBonus(
          makeFleetWithCt(flagshipIsCt: true, flagshipLevel: 45, ctCompanionCount: 1, ctCompanionLevel: 30),
        ),
        equals(16.0),
      );
      expect(
        GameInfoNoticeController.calculateFleetTrainingCruiserBonus(
          makeFleetWithCt(flagshipIsCt: true, flagshipLevel: 75, ctCompanionCount: 1, ctCompanionLevel: 30),
        ),
        equals(20.0),
      );
      expect(
        GameInfoNoticeController.calculateFleetTrainingCruiserBonus(
          makeFleetWithCt(flagshipIsCt: true, flagshipLevel: 120, ctCompanionCount: 1, ctCompanionLevel: 30),
        ),
        equals(25.0),
      );
    });
    ...
    test('Mode 3: Companion 1 only (no CT flagship)', () {
      expect(
        GameInfoNoticeController.calculateFleetTrainingCruiserBonus(
          makeFleetWithCt(flagshipIsCt: false, flagshipLevel: 50, ctCompanionCount: 1, ctCompanionLevel: 5),
        ),
        equals(3.0),
      );
      expect(
        GameInfoNoticeController.calculateFleetTrainingCruiserBonus(
          makeFleetWithCt(flagshipIsCt: false, flagshipLevel: 50, ctCompanionCount: 1, ctCompanionLevel: 20),
        ),
        equals(5.0),
      );
      expect(
        GameInfoNoticeController.calculateFleetTrainingCruiserBonus(
          makeFleetWithCt(flagshipIsCt: false, flagshipLevel: 50, ctCompanionCount: 1, ctCompanionLevel: 40),
        ),
        equals(7.0),
      );
      expect(
        GameInfoNoticeController.calculateFleetTrainingCruiserBonus(
          makeFleetWithCt(flagshipIsCt: false, flagshipLevel: 50, ctCompanionCount: 1, ctCompanionLevel: 80),
        ),
        equals(10.0),
      );
      expect(
        GameInfoNoticeController.calculateFleetTrainingCruiserBonus(
          makeFleetWithCt(flagshipIsCt: false, flagshipLevel: 50, ctCompanionCount: 1, ctCompanionLevel: 110),
        ),
        equals(15.0),
      );
    });
    ...
    test('Mode 4: Companion 2 only (no CT flagship)', () {
      expect(
        GameInfoNoticeController.calculateFleetTrainingCruiserBonus(
          makeFleetWithCt(flagshipIsCt: false, flagshipLevel: 50, ctCompanionCount: 2, ctCompanionLevel: 5),
        ),
        equals(4.0),
      );
      expect(
        GameInfoNoticeController.calculateFleetTrainingCruiserBonus(
          makeFleetWithCt(flagshipIsCt: false, flagshipLevel: 50, ctCompanionCount: 2, ctCompanionLevel: 20),
        ),
        equals(6.0),
      );
      expect(
        GameInfoNoticeController.calculateFleetTrainingCruiserBonus(
          makeFleetWithCt(flagshipIsCt: false, flagshipLevel: 50, ctCompanionCount: 2, ctCompanionLevel: 40),
        ),
        equals(8.0),
      );
      expect(
        GameInfoNoticeController.calculateFleetTrainingCruiserBonus(
          makeFleetWithCt(flagshipIsCt: false, flagshipLevel: 50, ctCompanionCount: 2, ctCompanionLevel: 80),
        ),
        equals(12.0),
      );
      expect(
        GameInfoNoticeController.calculateFleetTrainingCruiserBonus(
          makeFleetWithCt(flagshipIsCt: false, flagshipLevel: 50, ctCompanionCount: 2, ctCompanionLevel: 110),
        ),
        equals(17.5),
      );
    });

    test('Practice enemy info event formats decimal training cruiser bonus', () async {
      ...
      await controller.idle;
      expect(topNoticeController.current, isNotNull);
      // baseExp=557, sExp=668, boostedSExp=785, boostedAExp=654, bonus=17.5%
      expect(
        topNoticeController.current!.message,
        equals('演习经验（约）：S胜 785 · A胜 654 (练巡 +17.5%)'),
      );
      expect(topNoticeController.current!.tone, equals(TopNoticeTone.info));
    });
  });
  ...
  group('Requirement 3: Synchronous stateBefore capture (Race condition bug fix)', () {
    test('Captures stateBefore synchronously at accept time so mutations do not zero deltas', () async {
      var dynamicState = state; // Initial state: firepower=50, firepowerMax=52
  ...
  group('Requirement 4 & 8: 7-dimension modernization & safe int parsing', () {
    test('Modernization detects all 7 dimensions including HP and ASW', () async {
      final controller = GameInfoNoticeController(
        stateProvider: () => state,
        layoutSettingsController: layoutController,
        topNoticeController: topNoticeController,
    ...
    test('Modernization reports full max when no stats increased', () async {
      final maxedShip = makeShip(
        firepower: 52,
        firepowerMax: 52,
      );
    ...
    test('Poi parity: Nisshin Kai with equipment does NOT falsely flag Firepower as MAX', () async {
    ...
    test('Poi mathematical parity test across multiple stats and boundary conditions', () {
      ...
      int poiRemaining(int base, int max, int kyouka) => max - (base + kyouka);
      bool poiIsMax(int base, int max, int kyouka) => poiRemaining(base, max, kyouka) <= 0;
      ...
      for (final (statIndex, base, maxVal, kyouka, expectedMax) in testCases) {
        final poiRem = poiRemaining(base, maxVal, kyouka);
        final yahagiRem = master.remainingModernization(statIndex, kyouka);
        expect(yahagiRem, equals(poiRem), reason: 'Remaining must exactly match Poi');
  ...
  group('Requirement 5: Marriage luck bonus critical & MAX logic', () {
    test('+6 / MAX: critical double arrow and MAX when luck reaches cap', () async {
      ...
      await controller.idle;
      expect(topNoticeController.current!.message, equals('誓约运提升：运 ▲▲ +6 / MAX'));
      expect(topNoticeController.current!.tone, equals(TopNoticeTone.marriage));
    });

    test('+5 / +12: critical double arrow when delta > 4 but remaining > 0', () async {
      ...
      await controller.idle;
      expect(topNoticeController.current!.message, equals('誓约运提升：运 ▲▲ +5 / +12'));
      expect(topNoticeController.current!.tone, equals(TopNoticeTone.marriage));
    });

    test('+3 / +35: normal single arrow when delta <= 4 and remaining > 0', () async {
      ...
      await controller.idle;
      expect(topNoticeController.current!.message, equals('誓约运提升：运 ▲ +3 / +35'));
      expect(topNoticeController.current!.tone, equals(TopNoticeTone.marriage));
    });
  });
  ...
  group('Requirement 6: Sortie safety checks & composite warnings', () {
    ...
    test('Ship capacity low and item capacity full gives Error priority', () async {
      final stateWithItemFull = state.copyWith(
        maxShipCount: 5,
        ships: {1: state.ships[1]!, 2: state.ships[1]!}, // 3 ships left (low warning)
        maxEquipmentCount: 2,
        slotItems: {
          1: const OwnedSlotItem(instanceId: 1, masterSlotItemId: 10),
          2: const OwnedSlotItem(instanceId: 2, masterSlotItemId: 10),
    ...
    test('Both ship and item capacity low triggers composite warning', () async {
    ...
    test('Uncounted equipment (damage control, combat rations) does not reduce remaining equipment capacity', () async {
      ...
      final stateWithUncounted = state.copyWith(
        ...
        slotItems: {
          ...
          for (int i = 3; i <= 12; i++)
            i: OwnedSlotItem(instanceId: i, masterSlotItemId: i.isEven ? 42 : 43),
        },
      );
  ...
  group('Requirement 7: Multi-language i18n support', () {
    ...
    test('Notices are localized into Traditional Chinese when localeCode is zh_Hant', () async {
  ...
  group('Equipment development & Settings toggle', () {
    test('3-batch development formats slot-by-slot with slash', () async {
      ...
      controller.accept(
        createEvent(
          '/kcsapi/api_req_kousyou/createitem',
          '{"api_result":1,"api_data":{"api_get_items":['
              '{"api_create_flag":1,"api_slot_item":{"api_id":1,"api_slotitem_id":42}},'
              '{"api_create_flag":1,"api_slot_item":{"api_id":2,"api_slotitem_id":43}},'
              '{"api_create_flag":0,"api_slot_item":null}'
              ']}}',
        ),
      );
  ...
  group('Devil Review: Second Round Adversarial & Edge Case Verification', () {
    test('Scenario A: Stat already maxed prior to modernization (delta 0) is omitted from notice', () async {
      const master = MasterShip(
        id: 1,
        name: '吹雪',
        shipTypeId: 2,
    ...
    test('Scenario B: All stats already maxed when modernized again (all deltas 0) reports max cap notice', () async {
      const master = MasterShip(
        id: 1,
        name: '吹雪',
        shipTypeId: 2,
    ...
    test('Scenario C: Multi-language parity (zh, zh_Hant, ja) across all notice types', () async {
      // 1. Japanese (ja)
      await layoutController.setLocaleCode('ja');
      ...
      expect(topNoticeController.current!.message, equals('近代化改修成功：火力 ▲ 2 (MAX)'));
      ...
      expect(topNoticeController.current!.message, equals('近代化改修成功 (能力値は既に上限です)'));
      ...
      await jaController.idle;
      expect(topNoticeController.current!.message, equals('ケッコンカッコカリ：運 ▲ +3 / +35'));
      ...
      await jaController.idle;
      expect(topNoticeController.current!.message, equals('ケッコンカッコカリ：運 ▲▲ +38 / MAX'));
      ...
      await jaController.idle;
      expect(topNoticeController.current!.message, equals('演習経験値（約）：S勝利 631 · A勝利 526'));
      ...
      expect(topNoticeController.current!.message, equals('改修成功：火力 ▲ 2 (MAX)'));
      ...
      expect(topNoticeController.current!.message, equals('改修成功 (屬性已達上限)'));
      ...
      await zhHantController.idle;
      expect(topNoticeController.current!.message, equals('誓約運提升：運 ▲ +3 / +35'));
      ...
      await zhHantController.idle;
      expect(topNoticeController.current!.message, equals('演習經驗（約）：S勝 631 · A勝 526'));
    ...
    test('Scenario D: Extreme inputs for Luck (Maruyu overflow), HP, and ASW', () async {
      ...
      expect(topNoticeController.current!.message, equals('改修成功：运 ▲ 8 (MAX)'));
      ...
      expect(topNoticeController.current!.message, equals('改修成功：耐久 ▲ 2 (MAX)'));
      ...
      expect(topNoticeController.current!.message, equals('改修成功：对潜 ▲ 2 (MAX)'));
      ...
      // All deltas 0 -> reports max cap notice:
      expect(topNoticeController.current!.message, equals('改修成功 (属性已达上限)'));
    });

    test('Scenario E: Graceful degradation when Master stats cache is missing/zero (legacy cache)', () async {
