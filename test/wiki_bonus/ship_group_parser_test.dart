...
ExpandedCell cell(String html) {
  final table = html_parser
      .parse('<table><tr><td>$html</td></tr></table>')
      .querySelector('table')!;
...
void main() {
  group('parseShipGroup', () {
    ...
    test('link + 型 suffix becomes class anchor', () {
      final r = parseShipGroupSafe(
        cell('<a href="/kancolle/%E7%99%BD%E9%9C%B2" title="白露">白露</a>型'),
      );
      final s = r as ShipGroupSpec;
