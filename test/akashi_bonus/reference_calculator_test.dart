...
void main() {
  ...
  group('count cases (5)', () {
    ...
    test('雪風改二 x2: 火力+5 回避+2', () {
      expect(run(656, count: 2).bonus.stats, {'firepower': 5, 'evasion': 2});
    });
    test('雪風改二 x3: 火力+6 回避+3', () {
      expect(run(656, count: 3).bonus.stats, {'firepower': 6, 'evasion': 3});
    });
    test('天津風改二 x2: 火力+5', () {
  ...
  group('synergy cases (5)', () {
    test('雪風改二 + radar: +2/+3/+1 once', () {
      ...
      expect(r.bonus.stats, {'firepower': 4, 'torpedo': 3, 'evasion': 2});
    });
    ...
    test('丹陽(651) + radar: +2/+3/+1 (override)', () {
      ...
      expect(r.bonus.stats, {'firepower': 3, 'torpedo': 3, 'evasion': 2});
    });
    test('multi-copy synergy does not repeat (once)', () {
      final r = run(656, count: 3, radar: true);
      expect(r.bonus.stats, {'firepower': 8, 'torpedo': 3, 'evasion': 4});
    });
  });
